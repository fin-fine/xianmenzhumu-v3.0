import{r as g,j as s}from"./react-BWYN-Uif.js";import{T as oe}from"./TraitTag-DjHMyMPy.js";import{A as Ne}from"./panel-family-J6-sniT3.js";import{aU as ve,et as we,bV as Ee,aq as Se,eu as Ie,ev as Te,X as ae,ew as Ae,an as Me,ep as Re,am as Oe,ap as Ce,ex as Be,ey as ke,B as De,K as He,er as le,i as ce}from"./game-core-BIAaMmH2.js";import{t as de}from"./panel-revenge-DOnO-pix.js";import{b as Pe,B as Le,F as _e}from"./relationshipSummary-DRCBbxga.js";import{d,g as k,a as P,c as ge,b as Q}from"./detailStyles-CQDnNuil.js";import"./world-events-core-D14mGr3s.js";import"./revenge-state-shared-ZlRdYP6Z.js";import"./revenge-core-BO-EI3CV.js";import"./panel-npc-Cc77zK_k.js";const q=(e,t)=>t?`
【${e}】
...
`)},ze=(e,t,i={},o="")=>{var D,B,R,H,L,U,Y,W;const a=Ve.test(String(o||"")),p=Se(e),b=((D=t==null?void 0:t.spouse)==null?void 0:D.id)===e.id||e.spouseId===(t==null?void 0:t.id)||((B=i.npcs)==null?void 0:B.some(v=>v.id===e.id&&v.spouseId===(t==null?void 0:t.id))),u=((R=e.relationship)==null?void 0:R.affection)||0;let n="陌生";b?u>=80?n="深爱":u>=60?n="亲密":u>=40?n="熟络":u>=20&&(n="认识"):p?u>=80?n="挚友":u>=60?n="好闺蜜":u>=30?n="好友":u>=20&&(n="相识"):u>=80?n="深交挚友":u>=60?n="亲近":u>=40?n="熟络":u>=20&&(n="认识");const m=((H=e.relationship)==null?void 0:H.jealousy)||e.jealousy||0;let r="平静",c="";m>=81?(r="修罗场",c="你现在极度嫉妒，情绪濒临失控，可能会质问、冷战、甚至做出极端行为"):m>=61?(r="大醋",c="你现在很吃醋，内心充满不满和委屈，会明显表现出不高兴"):m>=41?(r="中醋",c="你有些吃醋，会旁敲侧击、阴阳怪气地试探"):m>=21&&(r="微醋",c="你有一点小情绪，欲言又止，会不经意流露出在意");const y=((L=e.personality)==null?void 0:L.label)||"普通",h=((U=e.personality)==null?void 0:U.desc)||e.desc||"性格平和",$=e.identity||"修士",j=e.tierTitle||"凡人",x=Xe(e,t,i),w=qe(t,i),E={凡人:"凡人之躯",练气:"练气修行者",筑基:"筑基期修士",金丹:"金丹期高手",元婴:"元婴期强者",化神:"化神期大能",大乘:"大乘期至尊",渡劫:"渡劫期仙人",仙:"仙界之人"}[j]||j;let l="";b&&(l+=`
你们已结为道侣，是彼此最亲密的伴侣。`);const N=((Y=i.children)==null?void 0:Y.filter(v=>v.parentId===e.id||v.fatherId===e.id||v.motherId===e.id||v.fatherName===e.name||v.motherName===e.name))||[];if(N.length>0){const v=N.map(O=>`${O.name}（${O.age}岁，${O.tierTitle||"凡人"}）`).join("、");e.gender==="男"?l+=`
